...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark " >
  <a class="navbar-brand" href="${contextRoot}/adminLogin">好食光市場後臺系統</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <ul class="navbar-nav mr-auto ">
      ...
      <a class="nav-link active" href="${contextRoot}/adminLogin">管理員首頁 <span class="sr-only">(current)</span></a>
      </li>

...
<%--     <form:form class="form" method="post" action="${contextRoot}/postProduct" modelAttribute="workProduct"> --%>
    <form:form  class="form-inline my-2 my-lg-0" action="${contextRoot}/product/category?productname=" modelAttribute="pcat">
     <input  class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" />
<!--       <a href="product/name/{productcategory}"> -->

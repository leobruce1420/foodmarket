...
<!--       </li> -->
    ...
    <form class="form-inline my-2 my-lg-0" action="${contextRoot}/product/name" method="get">
      <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search" id="name" name="name" autocomplete="off" required>
